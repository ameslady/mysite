            ...
            <div className="projects">
                    ...
                    <div class="col-9 mx-auto">
                        <div class="card mx-auto mb-3">
                            <img class="card-img-top" src={message} alt="Card image cap"></img>
                            <div class="card-body">
                                <h5 class="card-title">Message Board Application</h5>
                                <p class="card-text">Implemented both front and back end of a universal message board application using React, Express, Node.js, JSON, MongoDB, Bootstrap, and Git</p>
                                <a href="https://github.com/ameslady/messageboard" class="btn btn-primary">Learn More</a>
                         </div>
                        </div>
                    </div>
                        ...
                        <div class="col-9 mx-auto">
                            <div class="card mx-auto mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Recreated the infamous Tetris in C/C++ programming languages.</p>
                                    <a href="https://github.com/ameslady/tetris.git" class="btn btn-primary">Learn More</a>
                                </div>
                            </div>
                        </div>
